...
# --- Page setup ---
st.set_page_config(page_title="全方位戰情室 AI (v74.0)", layout="wide", page_icon="🏦")
st.markdown("### 🏦 全方位戰情室 AI (v74.0 最終版)")
